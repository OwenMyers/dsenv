...
#  when
#  it's not in use. This is not precisely timed: it may shut down up to
#  a minute
...
#c.LabApp.app_dir = '/home/<user>/<path>'

## Whether to start the app in core mode. In this mode, JupyterLab will run using
#  the JavaScript assets that are within the installed JupyterLab Python
#  package.
#  In core mode, third party extensions are disabled. The `--dev-mode` flag is
#  an
...
#c.LabApp.user_settings_dir = '/home/omyers/.jupyter/lab/user-settings'

## Whether to serve the app in watch mode
#c.LabApp.watch = False

## The directory for workspaces
#c.LabApp.workspaces_dir = '/home/omyers/.jupyter/lab/workspaces'
...
#  about
#  the arguments that the kernel understands. In particular, this means that
#  the
#  kernel does not receive the option --debug if it given on the Jupyter
#  command
#  line.
...
#  network via Session objects, and only need to work with the dict-based
#  IPython
...
#  for how long the kernel can take before being presumed dead. This affects
#  the
